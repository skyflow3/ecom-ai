/**
 * Purpose: Settings page client — user profile, plan info, security, and billing link.
 * Dependencies: @clerk/nextjs, @/lib/plans, lucide-react, UI components
 * Related: src/app/(dashboard)/settings/page.tsx, src/app/(dashboard)/billing/page.tsx
 *
