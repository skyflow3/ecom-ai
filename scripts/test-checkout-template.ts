...
const TEST_BUNDLES: CheckoutBundle[] = [
  {
    ...
    img: 'https://placehold.co/120x120/4CAF50/ffffff?text=1x',
    priceDisplay: '$79.00',
  ...
  },
  {
    ...
    img: 'https://placehold.co/120x120/2196F3/ffffff?text=3x',
    priceDisplay: '$47.40',
    compareDisplay: '$79.00',
    discountPct: '40%',
  },
  {
    ...
    shipValue: 'FREE',
    shipping: 'FREE SHIPPING',
    img: 'https://placehold.co/120x120/FF9800/ffffff?text=6x',
    priceDisplay: '$31.60',
    compareDisplay: '$79.00',
    discountPct: '60%',
  },
